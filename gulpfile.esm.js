...
import {
  ...
  cleanJs, lintEs, transpile, uglify,
 ...
 * -------------------------------------------------------------------------- */
const scripts = series(lintEs, transpile, uglify);
...
/**
 * Sounds - processes sounds files
 * -------------------------------------------------------------------------- */
const sounds = series(noise);
export const buildSounds = series(cleanSounds, sounds);
buildSounds.displayName = 'build:sounds';
buildSounds.description = 'Build sounds files';
...
export const build = series(
  clean, styles, scripts, images, statics, sounds, pages
);
